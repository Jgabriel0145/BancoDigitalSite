        ...
        <div class="container py-5 h-100">
            ...
            <div class="col col-xl-10">
                ...
                <div class="row g-0">
                    ...
                    <img src="/View/Assets/Img/Login/celular.png" style="width: 120%; height: 100%;"
                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                        ...
                        <div class="form-outline mb-4">
                            <input type="date" id="form2Example17" class="form-control form-control-lg" name="data_nasc"/>
                            <label class="form-label" for="form2Example17">Data de Nascimento</label>
                        </div>
                        ...
                        <div class="pt-1 mb-4">
                            <button class="btn btn-lg btn-block" type="submit" style="background-color: #FC7C04; color: #FFFFFF;">Cadastrar</button>
                        </div>

                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Já possui conta? <a href="/login"
                            style="color: #393f81;">Entrar</a></p>
                        </form>
